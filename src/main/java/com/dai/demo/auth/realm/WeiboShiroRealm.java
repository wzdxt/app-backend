 ...
 */
public class WeiboShiroRealm extends AuthenticatingRealm {
    ...
    public boolean supports(AuthenticationToken authcToken) {
        return authcToken instanceof AppAuthenticationToken && ((AppAuthenticationToken) authcToken).getType() == AppAuthenticationToken.TYPE_WEIBO;
    }
